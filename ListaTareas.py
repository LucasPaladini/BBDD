...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.boton_ingresar_tarea = QLineEdit(Form)
        self.boton_ingresar_tarea.setObjectName(u"boton_ingresar_tarea")
        self.boton_ingresar_tarea.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.gridLayout.addWidget(self.boton_ingresar_tarea, 0, 0, 1, 1)
...
#if QT_CONFIG(tooltip)
        self.boton_ingresar_tarea.setToolTip(QCoreApplication.translate("Form", u"<html><head/><body><p align=\"center\"><span style=\" font-weight:700;\"><br/></span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.boton_ingresar_tarea.setPlaceholderText(QCoreApplication.translate("Form", u"Agregar nueva tarea", None))
